              ...
              <div className="flex flex-col lg:flex-row flex-1">
                <div className="flex flex-col lg:flex-row flex-1 items-center justify-center">
                  <div className="bg-white p-5 rounded-lg shadow-lg h-full flex flex-col justify-center items-center gap-4">
                    <img
                      src={user && user.avatar?.url ? user.avatar?.url : "https://res.cloudinary.com/didzyox00/image/upload/v1739278143/LIBRARY_MANAGEMENT_SYSTEM_ADMIN_AVATARS/qirmgel30lcne02dqsuw.jpg"}
                      alt="avatar"
